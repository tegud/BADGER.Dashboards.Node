(function () {
    ...
    TLRGRP.BADGER.Dashboard.Components.KafkaTopicStatusSentinel = function (configuration) {
        ...
        var topicList = new TLRGRP.BADGER.Dashboard.ComponentModules.KafkaTopicStatusSentinel();
