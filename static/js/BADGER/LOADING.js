LOADING = (function () {
    ...
    return {
        show: function () {
            ...
            overlay = $('<div />', { 'class': 'loading-overlay' }).appendTo('body');
            canvas = $('<canvas class="loading-canvas" id="loading-canvas" width="150" height="150"></canvas>').appendTo('body');
            var $document = $(document);

            canvas.css({
                top: ($document.height() - 150) / 2,
                left: ($document.width() - 150) / 2
            });
